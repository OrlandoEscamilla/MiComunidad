...
<div class="row">
    ...
    <aside id="mod_admin" class="col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0">
        ...
        <div class="panel panel-default admin-responsive">
            <div class="panel-heading">
                <div class="panel-title">ELIGE UNA ENCUESTA</div>
            </div>
            <div class="panel-body">
                <form action="" class="form-horizontal col-xs-12">
                    <select id="menu-admin" class="form-control">
                        <option value="">presiona para elegir</option>
                        <option value="opt-cc">ENCUESTA DEL SITIO</option>
                    </select>
                </form>
            </div>
        </div>
        ...
        <div class="panel panel-default admin-nonresponsive">
            <div class="panel-heading">
                <div class="panel-title">ELIJE UNA ENCUESTA</div>
            </div>
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    <li id="show_cc" role="presentation" class="admin-opcion">
                        <a href="#mod_cc">ENCUESTA DEL SITIO</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section id="mod_disclaimer" class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-0">
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">ENCUESTAS</p>
            </div>
            <div class="panel-body no-padding bienvenido">
                <div class="well" style="font-size: 20px">
                    <p class="text-justify">Bienvenido, la idea de esta sección es poder ofrecer a los alumnos y
                        profesores del ITCM un lugar donde puedan publicar encuestas para los estudios/proyectos que
                        esten llevando acabo.</p>
                    <p>Por ejemplo, para la materia de Taller de Investigación II, la cuál todos los alumnos cursamos
                        debemos realizar ciertas actividades de recolección de información. Para el caso anterior y
                        otros más este espacio es ideal para publicar nuestras encuestas e invitemos a los demás
                        estudiantes a apoyar.</p>
                    <p>En el panel anterior aparecerán las encuestas actualmente activas, por favor apoya respondiendo,
                        Gracias.</p>
                </div>
            </div>
        </div>
    ...
    <section id="mod_cc" class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-0">
        <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSfcXgSYw6P2DJ_nm3m9AOhrVmtvV4Umm44EUXUo0tAMeR7IZA/viewform?embedded=true"
            width="100%" height="500" frameborder="0" marginheight="0" marginwidth="0">Cargando…
        </iframe>
    </section>
    <!-- SECCIÓN C.C. -->
    ...
    <section id="mod_ss" class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-0">
        <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLScWNmOuJHdooNZNwPqGYmJBsVxux8yajZe96m__YqHYQtwO0g/viewform?embedded=true"
            width="100%" height="500" frameborder="0" marginheight="0" marginwidth="0">Cargando...
        </iframe>
    </section>
    <!-- SECCIÓN S.S. -->
